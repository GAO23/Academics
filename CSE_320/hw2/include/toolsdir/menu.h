...
extern int menu_match(int* ptr_rval, char** ptr_user_response, char* prompt, int case_significant, int initial_substring_sufficient, int repeat_if_no_match, int repeat_if_ambiguous, int n_options,...);
